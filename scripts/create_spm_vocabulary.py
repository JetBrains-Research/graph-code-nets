...
def main():
    ...
    parser.add_argument("bos_id", default=1, type=int, help="Beginning of sentence id")

    parser.add_argument("eos_id", default=2, type=int, help="End of sentence id")

    parser.add_argument("unk_id", default=3, type=int, help="Unknown id")
